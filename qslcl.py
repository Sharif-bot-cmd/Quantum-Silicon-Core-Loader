#!/usr/bin/env python3
# qslcl.py — Universal QSLCL Tool v1.2.3
...
# =============================================================================
# QSLCL STRUCTURE PARSING UTILITIES
# =============================================================================
...
class QSLCLLoader:
    ...
    # ---------------------------------------------
    # CONSOLIDATED QSLCLPAR PARSER - UPDATED FOR STRUCTURED FORMAT
    # ---------------------------------------------
    def load_qslclpar(self, blob):
        """Consolidated QSLCLPAR parser with structured format support"""
        out = {}
        ...
        while pos < len(blob):
            ...
            try:
                # Parse header: <8sBBHI (magic, version, flags, count, data_len)
                if idx + 16 > len(blob):
                    pos = idx + 1
                    continue
                ...
                for i in range(count):
                    if cmd_pos + 40 > len(blob):  # Minimum command header size
                        break
                    ...
                    command_entry = {
                        "name": name,
                        "opcode": opcode,  # This replaces QSLCLEND opcodes
                        "flags": cmd_flags,
                        "tier": tier,
                ...
                if commands_found > 0:
                    print(f"[*] QSLCLPAR: Found {commands_found} commands (v{version})")
                    break

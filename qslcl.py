#!/usr/bin/env python3
# qslcl.py — Universal QSLCL Tool v1.1.8
# Author: Sharif — QSLCL Creator
import sys, time, argparse, zlib, struct, threading, re, os, random, math, shutil, gzip, json, itertools

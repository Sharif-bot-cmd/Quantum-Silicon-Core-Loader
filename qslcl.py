#!/usr/bin/env python3
# qslcl.py — Universal QSLCL Tool v1.2.2
...
class QSLCLLoader:
    ...
    # ---------------------------------------------
    # QSLCLDISP PARSER - FIXED: Magic length
    # ---------------------------------------------
    ...
    # ---------------------------------------------
    # RTF PARSER - FIXED: Magic validation
    # ---------------------------------------------
    ...
    # ---------------------------------------------
    # IDX PARSER - FIXED: Magic validation
    # ---------------------------------------------
    ...
    # ---------------------------------------------
    # VM5 PARSER - FIXED: Magic validation
    # ---------------------------------------------
    ...
    # ---------------------------------------------
    # USB ROUTINES PARSER - FIXED: Magic validation
    # ---------------------------------------------
    ...
    # ---------------------------------------------
    # SPT SETUP PACKETS PARSER - FIXED: Magic validation
    # ---------------------------------------------
    ...
    # ---------------------------------------------
    # HEADER / CERTS PARSER - FIXED: Magic validation
    # ---------------------------------------------
    ...
    def parse_loader(self, blob):
        ...
        if "QSLCLDIS" in discovered:
            for pos in discovered["QSLCLDIS"]:
                try:
...
def validate_binary_compatibility(blob):
    ...
    # Check for any QSLCL magic - more flexible
    if blob[:8] not in [b"QSLCLBIN", b"QSLCLBST", b"QSLCLPAR", b"QSLCLHDR"]:
        print(f"[!] Invalid QSLCL binary header: {blob[:8]}")
        return False
    ...
    if not found_blocks:
        ...
        # Still return True for partial binaries
        return True
...
# =============================================================================
# LOADER SENDER - FIXED: Added proper closing
# =============================================================================
...
# =============================================================================
# UPDATED MAIN FUNCTION WITHOUT BOOTSTRAP COMMAND
# =============================================================================
def main():
    # -----------------------------------------------
    ...
    # -----------------------------------------------
    # COMMAND DEFINITIONS - REMOVED BOOTSTRAP COMMAND
    # -----------------------------------------------

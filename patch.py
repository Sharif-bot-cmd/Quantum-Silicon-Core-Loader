...
def build_img4_trust_capsule(elf: bytes) -> bytes:
    ...
    LOW_LEVEL_MEMORY_MAP = {
        "Qualcomm": {
            ...
            "TZRAM": (0xFE800000, 0xFEBFFFFF),
            "Watchdog": 0xFC4B8000,
            "UART": 0x078B0000
        },
        "MediaTek": {
            "SRAM": (0x20100000, 0x2011FFFF),
            "Watchdog": 0x10007000,
            "UART": 0x11002000,
            "SPI": 0x1100C000
        },
        "Unisoc": {
            "SRAM": (0x00020000, 0x0003FFFF),
            "Watchdog": 0x20BC0000,
            "UART": 0x70100000
        },
        "Samsung": {
            "SRAM": (0x02020000, 0x0203FFFF),
            "TZRAM": (0x02040000, 0x0205FFFF),
            "Watchdog": 0x10060000,
            "UART": 0x12C00000
        },
        "Rockchip": {
            "SRAM": (0x10000000, 0x1003FFFF),

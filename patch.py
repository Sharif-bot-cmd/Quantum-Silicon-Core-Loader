...
BASE_COMMANDS = [
    "read", "write", "erase", "peek", "poke", "unlock", "lock", "dump", "reset", "reboot", "bypass", "spoof", "breach", "hijack", "glitch", "attacks", "trigger"
]
...
def inject_quantum_endpoint_matrix():
    ...
    for i in range(1, 16):  # USB spec: max 15 endpoints per direction (1–15)
        ...
        ep_in = {
            ...
            "address": ep_in_addr,
            "type": "bulk",
            "entropy_sig": hashlib.blake2b(endpoint_hash[i*4:i*8], digest_size=32).hexdigest(),
            "logic_echo": True,
            "adaptive": True
        }
        ...
        ep_out = {
            ...
            "address": ep_out_addr,
            "type": "bulk",
            "entropy_sig": hashlib.blake2b(endpoint_hash[i*8:i*12], digest_size=32).hexdigest(),
            "write_sink": True,
            "mirror_accept": True
        }
...
def entropic_endpoint_signature_map():
    ...
    for ep in matrix.get("endpoints", []):
        ...
        endpoint_signatures[ep_addr] = {
            ...
            "detected_shape": hashlib.blake2b(combined_sig.encode(), digest_size=32).hexdigest(),

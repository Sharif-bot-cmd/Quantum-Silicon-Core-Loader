...
def generate_command_code(
    ...
    TIER = {
        ...
        "FUZZ":4,"BOOTSTRAP":1,"CHECKSUMS":2
    }
    ...
    def generate_functional_payload():
        if family == "SYS":
            ...
            if C == "BOOTSTRAP": return uop("LOAD",0,0x4000)+uop("JMP",0,0)+uop("RET")
...
def build_qslcl_bin(
    ...
    command_list = [
       ...
       "FOOTER","RAWSTATE","FUZZ","BOOTSTRAP"
    ]
    ...
    embed_certificate_strings(
        image,
        cert_text=f"QSLCL Universal Binary v5.9\nArchitecture: {arch}\nBuild: {time.ctime()}",
        auth_key=auth_key,
    ...
    if debug:
        print(f"\n[*] QSLCL Universal Binary v5.9 Build Complete")

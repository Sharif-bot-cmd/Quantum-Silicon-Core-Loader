...
def nano_kernel_microservices(
    ...
    # ============================================================
    # FIX 2: Updated to return bytearray instead of pointer
    # ============================================================
    ...
    return image  # FIXED: Return image, not ptr
...
def generate_command_code(
    ...
    if secure_mode and include_header:
        ...
        outer_header += b"QSLCLCMD"  # Outer wrapper magic
...
def build_qslcl_bin(
    ...
    # FIX 3: Call nano_kernel_microservices correctly
    microservices_offset = pad_cursor(0x6000, buf=image)
    # Pass required parameters
    nano_kernel_microservices(
        image, 
    ...
    # FIX 4: Call generate_standard_setup_packets correctly
    usb_setup_offset = pad_cursor(0x8000, buf=image)
    generate_standard_setup_packets(
        image, 

...
def generate_virtual_com_port():
    com_number = random.randint(10, 250)  # Avoid low numbers like COM1–COM3 (often used)
...
def main():
    ...
    if virtual_usb:
        ...
        try:
            ...
            print(f"[ERROR] VUSB initialization failed: {e}")
            sys.exit(1)

    elif virtual_com:
        print("[VCOM] Virtual COM mode triggered. qslcl.elf must handle this entry.")
        # If no override is set, fall back to spoofed virtual port for simulation
